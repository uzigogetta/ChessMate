  ...
  return (
    <View style={{ height: BASE, width: BASE + extra }}>
      ...
      <View style={{ position: 'absolute', right: 0, top: 0, height: BASE, width: BASE }}>
        <View style={{ position: 'absolute', left: (BASE - WELL) / 2 + (cloudVisible ? 0 : 3.5), top: (BASE - WELL) / 2, width: WELL, height: WELL, borderRadius: WELL / 2, alignItems: 'center', justifyContent: 'center' }}>
          <ConnectionIndicator />
        </View>
      </View>
      {cloudVisible && (
